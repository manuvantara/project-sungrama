...
namespace Game.ContractInteractions
{
    public class ContractInteraction
    {
        ...
        public static async Task<Receipt> Transfer(string recipientAddress, string id, int amount)
        {
            try
            {
                var result = await m_CollectionContract.Write(
                    "safeTransferFrom",
                    await m_ThirdwebSdk.wallet.GetAddress(),
                    recipientAddress,
                    BigInteger.Parse(id),
        ...
        public static async Task<Receipt> Approve()
        {
            try
            {
                var result = await m_CollectionContract.Write("setApprovalForAll", WORKBENCH, true);
