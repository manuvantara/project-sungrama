...
namespace GameWallet.Base
{
    ...
    public abstract class BaseScreen : MonoBehaviour
    {
        ...
        {
            // set up MainUIManager and UI Document
            if (m_MainUIManager == null)
                m_MainUIManager = GetComponent<MainUIManager>();
            ...
            if (m_Document == null && m_MainUIManager != null)
                m_Document = m_MainUIManager.MainMenuDocument;
